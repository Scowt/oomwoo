...
| I/O + motor-driver PCB | [io-pcb](./contributions/io-pcb) | Ready to start work | I/O board with CM4/CM5 socket, STM32G070 MCU - motors, sensors, 4S2P charging, safety, FreeRTOS, custom serial to CM4/CM5, 2D LiDAR header, IMU, audio serial/amp/speaker; KiCad, JLCPCB |
